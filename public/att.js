...
(function () {
    ...
    */
    ...
    function Att(config) {
        ...
        if (!options.dependencyBaseUrl) {
            options.dependencyBaseUrl = '//js.att.io';
        }
        ...
        if (options.version === 'a1' || options.version === 'a2') {
            $.getScript(options.dependencyBaseUrl + '/js/att.' + options.version + '.js', function () {
                self.create(options);    
            });    
        } else {
            $.getScript(options.dependencyBaseUrl + '/js/phono.06.js', function () {
